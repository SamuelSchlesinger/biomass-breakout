...
impl FontTexture {
        ...
        I: IntoIterator<Item = char>,
    {
        ...
        let font: rusttype::Font<'static> =
            rusttype::Font::try_from_vec(font).ok_or(Error::RusttypeError)?;
    ...
    F: Deref<Target = FontTexture>,
{
    ...
    pub fn set_text(&mut self, text: &str) {
        ...
        if !vertex_buffer_data.len() != 0 {
            ...
            self.vertex_buffer =
                Some(glium::VertexBuffer::new(&self.context, &vertex_buffer_data).unwrap());
    ...
    I: Iterator<Item = char>,
{
    ...
    // adding blank lines at the end until the height of the texture is a power of two
    {
        ...
        texture_data.extend(
            iter::repeat(0.0).take((texture_width * (requested_height - current_height)) as usize),
        );
    }
